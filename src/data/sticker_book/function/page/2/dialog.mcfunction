$dialog show @s { \
    ...
    body: [{ \
        ...
        contents: { \
            ...
            with: [ \
                {translate: 'gui.sticker_book.page.tropics.right'}, \
                {translate: 'gui.sticker_book.page.tropics.left'}, \
                ...
                {translate: 'gui.sticker_book.nav.both', with: [ \
                    ...
                    {translate: 'gui.sticker_book.arrow.next', hover_event: {action: 'show_text', value: {translate: 'gui.sticker_book.nav.next'}}, click_event: {action: 'run_command', command: 'trigger sticker_book.action set 2'}} \
                ]}, \
                {translate: 'gui.sticker_book.tabs', with: [ \
                    ...
                    {translate: 'gui.sticker_book.tab.tropics.selected'}, \
